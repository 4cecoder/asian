...
| TASK-178 | _(not in source)_                                        | —          | Cluster header claims TASK-171–TASK-180 exist; TASK-178 has no content in the source document.                                                                                                                                                  | —                                                                                                                       |
| TASK-179 | _(not in source)_                                        | —          | Same as TASK-178 — absent from source.                                                                                                                                                                                                          | —                                                                                                                       |
| TASK-180 | _(not in source)_                                        | —          | Same as TASK-178 — absent from source.                                                                                                                                                                                                          | —                                                                                                                       |

## Related packages

- [[t06-llm-inference-core]] — TASK-176's structured-output guard is the output-side counterpart to TASK-106's structured-output _enforcement_.
